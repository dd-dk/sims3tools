...
namespace RigEditor
{
    public partial class TripleEditor : UserControl
    {
        GrannyRigData.Triple value = new GrannyRigData.Triple(0, null);
        public TripleEditor()
        {
            InitializeComponent();
        }
        ...
        public GrannyRigData.Triple Value
        {
            get { return value; }
            set
            {
                this.value = new GrannyRigData.Triple(0, null, value);
