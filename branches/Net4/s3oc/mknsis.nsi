...
!define PROGRAM_NAME "s3oc - Sims3 Object Cloner"
...
gotAll:  
  ...
  WriteRegStr SHCTX "Software\Microsoft\Windows\CurrentVersion\Uninstall\${INSTREGKEY}" "HelpLink" "http://dino.drealm.info/den/denforum/index.php?board=20.0"
